...
if [[ -z $VERBOSE ]]; then
  ...
  rsync -ah --delete --info=progress2 --no-inc-recursive /media/chrislaskey/6E0C95A50C95693B/Users/conta/My\ Drive/Takeout/ /mnt/synology/Storage/Google\ Drive/Takeout
fi
